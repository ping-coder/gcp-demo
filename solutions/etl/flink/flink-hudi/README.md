...
/usr/lib/flink/bin/flink run -c ping.coder.gcp.sample.flink.FlinkHudiDemo flink-iceberg-1.0-SNAPSHOT.jar

/usr/lib/flink/bin/flink run-application -t yarn-application  -c ping.coder.gcp.sample.flink.FlinkHudiDemo flink-iceberg-1.0-SNAPSHOT.jar
...
mvn install:install-file -Dfile='lib/hudi-flink1.15-bundle-0.12.3.jar' -DgroupId='org.apache.hudi' -DartifactId='hudi-flink1.15-bundle' -Dversion='0.12.3' -Dpackaging=jar -DgeneratePom=true
